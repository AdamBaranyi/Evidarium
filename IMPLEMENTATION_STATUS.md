...
| Deployment auf vps1 ausgefuehrt                          | fertig (23.09.2026)                       |
| Nächtliche Sicherung, Probe des Zurückspielens (N2)      | fertig, Timer auf vps1 aktiv (23.09.2026) |
...
- Bilder in der Fallstudie (22.09.2026, Adams OK für zwei Fragen im Live-Modus): Startseite, belegte Antwort, Widerspruch, geöffneter Beleg, dazu Dokumente mit Projekten und Verbrauch aus dem angemeldeten Bereich; `bun scripts/bildschirmfotos.ts` macht sie neu, `… angemeldet` nur die zwei ohne Kosten.
