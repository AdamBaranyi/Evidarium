...
/* Die Datenschutzerklärung auf Deutsch — die massgebende Fassung. */
export function DatenschutzDe({ live }: { live: boolean }) {
  return (
    <>
      <p>
      ...
      <h2>Sprache</h2>
      <p>
        Wählst du oben eine Sprache, merkt sich das ein Cookie «evidarium_sprache» für ein Jahr. Es
        enthält nur das Kürzel der Sprache. Ohne eigene Wahl richtet sich die Sprache nach den
