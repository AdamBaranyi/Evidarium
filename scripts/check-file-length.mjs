...
/**
 * Dokumentierte Ausschlüsse: von Drizzle erzeugte Migrationen und reine
 * Daten-Fixtures. Beides ist kein handgeschriebener Code.
 *
 * Die Ausnahme erlaubt nicht, eigene Logik dorthin zu verschieben.
 * Fixture-Dateien dürfen nur Daten enthalten.
 */
const EXCLUDED_PATHS = ['src/lib/db/migrations/', 'tests/fixtures/'];
