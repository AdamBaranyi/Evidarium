#!/usr/bin/env node
/**
 * Projektregel: keine Schrift unter 16 px, auf keiner Breite.
 *
 ...
 * auf jeder Seite und bei 320, 768 und 1440 Pixeln.
 */
...
/** Die Basis ist 16 px, siehe `html` in src/app/globals.css. */
...
function main() {
  ...
  if (count > 0) {
    console.error('\nKeine Schrift unter 16 px, auf keiner Breite. Siehe docs/CODE-QUALITY.md.');
    process.exit(1);
  }
